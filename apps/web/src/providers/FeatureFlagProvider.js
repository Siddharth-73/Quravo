...
function FeatureFlagProvider({ children, initialFeatures = defaultFeatures, }) {
    const [features, setFeaturesState] = (0, react_1.useState)({
        ...defaultFeatures,
        ...initialFeatures,
    });
    ...
    return (<FeatureFlagContext.Provider value={{ features, hasFeature, setFeatures }}>
      {children}
