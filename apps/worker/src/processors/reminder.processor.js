...
let ReminderProcessor = (() => {
    ...
    var ReminderProcessor = class {
        ...
        static {
            ...
            ReminderProcessor = _classThis = _classDescriptor.value;
            if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
            __runInitializers(_classThis, _classExtraInitializers);
        }
        configService;
        logger = new common_1.Logger(ReminderProcessor.name);
        worker;
        redisConnection;
        ...
        onModuleInit() {
            ...
            this.worker = new bullmq_1.Worker('reminder-queue', async (job) => {
    ...
    return ReminderProcessor = _classThis;
})();
