...
let PermissionsGuard = (() => {
    ...
    var PermissionsGuard = class {
        ...
        reflector;
        tenantCacheService;
        constructor(reflector, tenantCacheService) {
        ...
        async canActivate(context) {
            ...
            if (!user || !user.tenantId || !user.role) {
                throw new common_1.UnauthorizedException('Authentication credentials or active tenant role missing.');
            }
            ...
            const isAllowed = (0, common_2.hasAllPermissions)(grantedPermissions, requiredPermissions);
            if (!isAllowed) {
