...
let BillingModule = (() => {
    let _classDecorators = [(0, common_1.Module)({
            ...
            controllers: [invoices_controller_1.InvoicesController, payments_controller_1.PaymentsController],
            providers: [invoices_service_1.InvoicesService, payments_service_1.PaymentsService, razorpay_provider_1.RazorpayProvider],
