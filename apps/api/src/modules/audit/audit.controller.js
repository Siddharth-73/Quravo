...
let AuditController = (() => {
    let _classDecorators = [(0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, permissions_guard_1.PermissionsGuard), (0, common_1.Controller)('audit-logs')];
    ...
    var AuditController = class {
        ...
        static {
            ...
            _getAuditLogs_decorators = [(0, common_1.Get)(), (0, permissions_decorator_1.RequirePermissions)('audit:read')];
        ...
        async getAuditLogs(req, page, limit, userId, action, startDate, endDate) {
