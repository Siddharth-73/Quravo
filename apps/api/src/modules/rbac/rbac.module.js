...
let RbacModule = (() => {
    let _classDecorators = [(0, common_1.Global)(), (0, common_1.Module)({
            ...
            providers: [rbac_service_1.RbacService, permissions_guard_1.PermissionsGuard, module_guard_1.ModuleGuard],
            exports: [rbac_service_1.RbacService, permissions_guard_1.PermissionsGuard, module_guard_1.ModuleGuard],
        })];
