...
let RateLimiterGuard = (() => {
    ...
    var RateLimiterGuard = class {
        ...
        static {
            ...
            RateLimiterGuard = _classThis = _classDescriptor.value;
        ...
        async canActivate(context) {
            ...
            if (!isRedisUp)
                return true; // Fail open in dev if Redis unavailable
            return true;
        }
    };
    return RateLimiterGuard = _classThis;
})();
