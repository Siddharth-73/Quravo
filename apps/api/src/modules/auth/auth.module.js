    ...
    let _classDecorators = [(0, common_1.Module)({
            imports: [
                ...
                jwt_1.JwtModule.registerAsync({
                    ...
                    useFactory: (config) => ({
                        secret: config.get('JWT_SECRET', 'super_secret_jwt_key_change_in_prod'),
            ...
            providers: [auth_service_1.AuthService, jwt_strategy_1.JwtStrategy, turnstile_guard_1.TurnstileGuard, rate_limiter_guard_1.RateLimiterGuard],
